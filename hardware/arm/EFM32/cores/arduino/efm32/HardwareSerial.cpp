...
void HardwareSerial::setRouteLoc(uint8_t route){
	switch(route){
		case 1:
			routeLoc = 1;
			USART_ROUTE_LOCATION_LOCx = USART_ROUTE_LOCATION_LOC1;
		  break;
		case 2:
			routeLoc = 2;
		    USART_ROUTE_LOCATION_LOCx = USART_ROUTE_LOCATION_LOC2;
		  break;
		case 3:
			routeLoc = 3;
		    USART_ROUTE_LOCATION_LOCx = USART_ROUTE_LOCATION_LOC3;
		  break;
#ifdef USART_ROUTE_LOCATION_LOC4
		  case 4:
			routeLoc = 4;
		    USART_ROUTE_LOCATION_LOCx = USART_ROUTE_LOCATION_LOC4; 
		  break;
#endif
#ifdef USART_ROUTE_LOCATION_LOC5
		  case 5:
			routeLoc = 5;
		    USART_ROUTE_LOCATION_LOCx = USART_ROUTE_LOCATION_LOC5; 
		  break;
#endif
#ifdef USART_ROUTE_LOCATION_LOC6
		  case 6:
			routeLoc = 6;
		    USART_ROUTE_LOCATION_LOCx = USART_ROUTE_LOCATION_LOC6; 
		  break;
#endif
		  default:
		  break;
...
#endif
#if defined(LEUSART0)&& (USE_LEUART0 >0)
...
#endif
#if	defined(LEUART0)&& (USE_LEUSRT0 >0)
    if(this->instance == (USART_TypeDef *)LEUART0){	
      NVIC_ClearPendingIRQ(LEUART0_IRQn);
      NVIC_EnableIRQ(LEUART0_IRQn);
	}
#endif
#if	defined(LEUART1)&& (USE_LEUSRT1 >0)
    if(this->instance == (USART_TypeDef *)LEUART1){	
